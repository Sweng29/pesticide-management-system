...
public static String MenuItem[]={"Unit Frame","Customer Frame","Dealer Frame","Product Frame","Purchase Frame","View Order","User Frame","Company Frame","Order Frame","View Purchase"};
public static JFrame frames[]={new UnitFrame(),new CustomerFrame(),new DealerFrame(),new ProductViewFrame(),new Purchase(),new ViewOrders(),new UserFrame(),new CompanyFrame(),new OrderFrame(),new ViewPurchase()};
public BoxLayout box;
     ...
     */
       public MainFrame() {
           ...
           initComponents();
           addMenu();
           userRole.setText(LoginFrame.userModel.getRole().getRoleName());
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Pesticide Management");
        jPanel_UP.add(jLabel4);
        jLabel4.setBounds(548, 59, 269, 31);
        ...
        jLabel2.setText("© 2017 Geeks Acedmy | All Right Reserved ");
